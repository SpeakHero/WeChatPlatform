        ...
        public override IResponseMessageBase OnEvent_ClickRequest(RequestMessageEvent_Click requestMessage)
        {
            ...
            switch (requestMessage.EventKey)
            {
                ...
                case "SubClickRoot_Music":
                    {
                        //上传缩略图
                        var accessToken = MP.CommonAPIs.AccessTokenContainer.TryGetToken(appId, appSecret);
                        var uploadResult = MP.AdvancedAPIs.MediaApi.UploadTemporaryMedia(accessToken, UploadMediaFileType.thumb,
                ...
                case "SubClickRoot_Image":
                    {
                        //上传图片
                        var accessToken = MP.CommonAPIs.AccessTokenContainer.TryGetToken(appId, appSecret);
                        var uploadResult = MP.AdvancedAPIs.MediaApi.UploadTemporaryMedia(accessToken, UploadMediaFileType.image,
                                                                     Server.GetMapPath("~/Images/Logo.jpg"));
                        //设置图片信息
