...
window.Modernizr = (function( window, document, undefined ) {
    ...
    /*jshint evil:true */
      ...
      var html5 = {
         ...
         * @type Array|String
         */
        'elements': options.elements || 'abbr article aside audio bdi canvas data datalist ÏêÏ¸ÐÅÏ¢ figcaption figure footer header hgroup mark meter nav output progress section summary time video',
